#!/bin/bash
#SBATCH --job-name=finetune_blip_mm_lr2e-6_       # 任务名
...
python -u train.py  \
    --name finetune_blip_mm_lr2e-6 \
    --lr 2e-6 \
    --checkpoint ../results/checkpoints/finetune_blip_mm/batchsize32_lr2e-06_200_71_0.2407766990291262.bin
echo "FINISH"                       # 输出起始信息
