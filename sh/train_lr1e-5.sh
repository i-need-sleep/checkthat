#!/bin/bash
#SBATCH --job-name=finetune_blip_mm_lr1e-5_       # 任务名
...
python -u train.py  \
    --name finetune_blip_mm_lr1e-5 \
    --lr 1e-5 \
    --checkpoint ../results/checkpoints/finetune_blip_mm/batchsize32_lr1e-05_295_71_0.5308641975308642.bin
echo "FINISH"                       # 输出起始信息
